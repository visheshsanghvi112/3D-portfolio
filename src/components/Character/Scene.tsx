...
const Scene = () => {
  ...
  useEffect(() => {
    if (canvasDiv.current) {
      ...
      // Cap device pixel ratio to avoid excessive GPU work on high-DPR devices
      ...
      // Use IntersectionObserver to only load the model when the canvas is visible
